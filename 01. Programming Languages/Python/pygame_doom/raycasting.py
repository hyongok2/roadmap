...
class RayCasting:
    ...
    def get_objects_to_renderers(self):
        self.objects_to_render = []
    ...
    def ray_casting(self):
        ...
        for ray in range(NUM_RAYS):
            ...
            # pg.draw.line(self.game.screen, 'yellow', (100 * ox, 100 * oy), (100 *
            #            ox + 100 * depth * cos_a, 100 * oy + 100 * depth * sin_a), 2)

            ray_angle += DELTA_ANGLE

    def update(self):
        self.ray_casting()
        self.get_objects_to_renderers()
